...
?>
	<div id="content">
		...
		<section id="topWelcome">
			<div class="sizer">
				<h1> Add New Deck </h1>
				<!-- <button type="button"><?php echo anchor("user/createdecks", "Create Deck", "Create New Deck"); ?></button> -->
			</div>
		</section>
		...
		<div class="sizer">
			...
			<div id="newDeck">
				...
				<!-- <form id="deckForm"> -->
				<?php echo form_open("user/createdeck", $att); ?>
					<p>Deck Title</p>
					<h2 class="titleError"></h2>
					<?php echo form_input($deckTitleData); ?>
					<p>Deck Privacy</p>
